    ...
    <main className="decorated-page quest-page">
      ...
      <div className="container container--size-l">
        <div className="quest-page__content">
          ...
          <Link className="btn btn--accent btn--cta quest-page__btn" to={AppRoute.Booking}>
            Забронировать
          </Link>
        </div>
      </div>
...
//         <div className="quest-page__content">
//           <h1 className="title title--size-l title--uppercase quest-page__title">Маньяк</h1>
//           <p className="subtitle quest-page__subtitle"><span className="visually-hidden">Жанр:</span>Ужасы </p>
//           <ul className="tags tags--size-l quest-page__tags">
//             <li className="tags__item">
//               <svg width="11" height="14" aria-hidden="true">
//                 <use xlinkHref="#icon-person"/>
